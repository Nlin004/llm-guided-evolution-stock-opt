...
DATA_PATH = os.path.join(ROOT_DIR, "sota/FinRL/data")
SOTA_ROOT = os.path.join(ROOT_DIR, 'sota/FinRL')
...
RUNLINE_TMP = '{}_{}'
EVAL_RUNLINE = "python {} -model {} -variant_dir {VARIANT_DIR}"
"""
...
start_population_size = 64  # Starting population size
...
population_size = 64 # with cx_prob (0.25) and mute_prob (0.7) you get about %50 successful turnover
